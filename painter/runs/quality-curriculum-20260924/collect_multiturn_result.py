...
def bundle(root: Path, output: Path, *, allow_partial: bool = False) -> dict:
    ...
    if not allow_partial:
        ...
        final = root / "train-output/multiturn-sft-20260925-v1/artifacts/adapters/step_40/hf-upload.json"
    ...
    for receipt in (root / "train-output/multiturn-sft-20260925-v1/artifacts/adapters").glob("step_*/hf-upload.json"):
    ...
    manifest = {"schema": "painter.multiturn-evidence.v1", "complete": not allow_partial,
                "members": members}
    ...
    receipt = {"schema": "painter.multiturn-evidence-receipt.v1", "archive": output.name,
