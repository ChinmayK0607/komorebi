...
Twenty-four disjoint source batches contain exactly 500 authored candidates: 248 text-prompt programs and 252 image-reference programs. The local [source review](../../collected/quality-curriculum-20260926/review/index.html) shows every input, prompt/plan, provenance, and program, explicitly without rendered paintings. All batches passed contract, JavaScript syntax, and manifest/hash checks. None in this campaign has a Linux rendering, visual-quality decision, or training admission. Twelve additional Sol photo repair programs reuse existing references and are **alternatives**, not 12 more distinct inputs. Source archives and raw audits are ignored by Git.

Independent source-to-program audits found substantial static risk. Astra-high classified 30 of the 76 Sol text sketches high risk and 46 medium risk; 75 of those 76 have only flat native geometry despite loading p5.brush. Sol-high classified 3/60 early Astra photo sketches high risk, 17 medium, 40 low; among 72 newer Astra photo sketches, 20 high, 22 medium and 30 low; and among the final 24 COCO photo sketches, 3 high, 12 medium and 9 low. These are unrendered structural-risk opinions, not visual failure rates. Source-specific hard scenes, such as crowded streets or sports, should be repaired or excluded rather than automatically admitted. One portrait with visible facial injury is explicitly marked likely to exclude for the user's non-horrific aesthetic target. The next decision depends on rendering and visual comparison, not the 500 source count.

Public upload of the new teacher source bundles is pending an explicit user answer after automatic approval review rejected the first batch's disclosure to a public dataset. That review cited possible proprietary prompts/programs and reference photos; Git and Codex Cloud jobs are not being used as an alternate publishing route. CPU rendering can begin once a permissible transfer path is available.
