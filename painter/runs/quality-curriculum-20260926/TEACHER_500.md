...
Twelve disjoint batches contain 212 authored candidates: 152 text-prompt programs (76 Sol-high, 76 Astra-high) and 60 image-reference programs (all Astra-high, across prior COCO128 train, COCO val2017, and Openverse CC0). This count denotes authored prompt/program pairs only. All have passed contract, JavaScript syntax, and manifest/hash checks; none in this campaign has a Linux rendering, visual-quality decision, or training admission. The source archives are local and ignored by Git. Later batches will rebalance toward image references and explicitly address the mechanical flat-shape appearance found in the Sol authoring audit. Successful rendering and visual review may substantially reduce the retained count.
